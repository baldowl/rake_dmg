= Rake DMG library {<img src="https://travis-ci.org/baldowl/rake_dmg.png?branch=master" alt="Build Status" />}[https://travis-ci.org/baldowl/rake_dmg] {<img src="https://badge.fury.io/rb/rake_dmg.png" alt="Gem Version" />}[http://badge.fury.io/rb/rake_dmg]
